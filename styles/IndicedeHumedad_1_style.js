...
var style_IndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.282453 && value <= -0.184988) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.184988 && value <= -0.087523) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.087523 && value <= 0.009943) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.009943 && value <= 0.107408) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.107408 && value <= 0.204874) {
            style = [ new ol.style.Style({
